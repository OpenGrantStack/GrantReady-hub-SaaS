...
@router.post("/webhooks/production")
async def production_webhook(
    ...
    logger.info("Production webhook received")
    # TODO: Production-only handling
    return {"status": "ok", "webhook": "production"}
`